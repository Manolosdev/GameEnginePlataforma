        ...
        for (int i1 = 0; i1 < entidades.size() - 1; i1++) {
            ...
            for (int i2 = i1 + 1; i2 < entidades.size(); i2++) {
                ...
                if (o1.pos.intersects(o2.pos)) {
                    ...
                    // Verifica a relação entre a largura e a altura da interseção, para 
                    // verificar o tipo de colisão, se vertical ou horrizontal.
                    if (rect.getWidth() > rect.getHeight()) {
                        ...
                        if (o1.pos.getCenterY() < o2.pos.getCenterY()) {
                            ...
                            o1.collidingEntities[Entidade.COLLIDING_BELOW] = o2;
                            // o2 está colidindo acima (above) com o1.
                            o2.collidingEntities[Entidade.COLLIDING_ABOVE] = o1;
                        } else {
                            // Se o1 está abaixo de o2...
                            o1.collidingEntities[Entidade.COLLIDING_ABOVE] = o2;
                            o2.collidingEntities[Entidade.COLLIDING_BELOW] = o1;
                        }
                    } else {
                        // Se a altura é maior que a largura, é colisão horizontal.
                        if (o1.pos.getCenterX() < o2.pos.getCenterX()) {
                            // Seo1 está á esquerda de o2...
                            o1.collidingEntities[Entidade.COLLIDING_RIGHT] = o2;
                            o2.collidingEntities[Entidade.COLLIDING_LEFT] = o1;
                        } else {
                            // Se o1 está à direita de o2...
                            o1.collidingEntities[Entidade.COLLIDING_LEFT] = o2;
                            o2.collidingEntities[Entidade.COLLIDING_RIGHT] = o1;
                        }
                    }
                }
            }
